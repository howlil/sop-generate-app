...
function WorkspaceHeader({ eyebrow, title, meta }: { eyebrow: string; title: string; meta: string }) {
  return (
    <div className="flex flex-col gap-4 border-b border-border pb-5 sm:flex-row sm:items-start sm:justify-between">
      ...
      <span className="w-fit border border-border-strong bg-surface-subtle px-2.5 py-1 text-[10px] font-medium text-secondary-foreground">{meta}</span>
    </div>
  )
}
  ...
  return (
    <div className="border border-border bg-surface p-5 sm:p-6">
      ...
      <div className="mt-5 grid gap-5 md:grid-cols-[0.58fr_0.42fr]">
        ...
        <div className="border-l-2 border-primary bg-primary-subtle p-4">
  ...
  return (
    <div className="border border-border bg-surface p-5 sm:p-6">
      ...
      <div className="mt-5 grid gap-5 md:grid-cols-[0.56fr_0.44fr]">
        ...
        <div className="border-l-2 border-warning bg-warning-subtle p-4">
    ...
    <div className="border border-border bg-surface p-5 sm:p-6">
      ...
      <div className="mt-5 grid gap-4 sm:grid-cols-3">
        {[
          ...
          <div key={title} className="border-t-2 border-primary bg-surface-subtle p-4">
