...
import { usePengajuanEvaluasiDetail } from "@/api/evaluasi";
import { RiwayatEvaluasiTimeline } from "@/components/evaluasi/RiwayatEvaluasiTimeline";
...
export function DetailPengajuanEvaluasi() {
  const { id } = useParams({
    from: "/biro-organisasi/evaluasi/$id",
  });
  ...
  if (!pengajuan) {
    return (
      <NotFoundWithBack
        ...
        backAction={
          <BackButton to={ROUTES.BIRO_ORGANISASI.EVALUASI}>
            Kembali
          </BackButton>
        }
      />
      ...
      >
        ...
        {previewMainTab === "ba" && pengajuan && (
          <BeritaAcaraTemplate
            ...
            tanggalVerifikasi={pengajuan.tanggalVerifikasi ?? undefined}
