...
export function ArsipSopTable({
  ...
  return (
    <>
      <p className="mb-3 text-sm text-slate-500 sm:hidden">
            ...
            <li key={sop.detailSopId}>
              <button
                ...
                className={cn(
                  ...
                  isCompact ? 'items-start' : 'flex-col gap-1 rounded-xl px-4 py-3 shadow-sm',
                  isSelected
              ...
              >
                <span className="min-w-0 flex-1">
                  <p className={cn('font-medium text-slate-900', isCompact && 'text-sm leading-snug')}>
                    {sop.judul}
                  </p>
                  {showOpdColumn ? (
                    <p className="mt-0.5 text-xs text-slate-600">{sop.opdNama}</p>
                  ) : null}
                  <p className={cn('text-slate-500', isCompact ? 'mt-0.5 text-xs' : 'text-sm')}>
...
function SopTableRow({
  ...
  return (
    ...
    >
      ...
      {showOpdColumn ? <Table.Td className="text-slate-600">{sop.opdNama}</Table.Td> : null}
