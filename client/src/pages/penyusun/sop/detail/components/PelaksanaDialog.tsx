...
export function PelaksanaDialog({
  ...
  return (
    <SearchableSelectDialog
      ...
      description="Cari pelaksana yang akan ditambahkan (nama atau kode). Data dari Kelola Pelaksana SOP."
      ...
      emptyMessage="Belum ada data pelaksana. Kelola di menu Kelola Pelaksana SOP."
