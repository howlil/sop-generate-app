...
export const SOP_DOCUMENT_CONTENT_WRAPPER_CLASS =
  'box-border min-w-0 w-full max-w-[calc(297mm-3cm)] print:mx-auto print:w-[calc(297mm-3cm)] print:min-w-[calc(297mm-3cm)] print:max-w-[calc(297mm-3cm)] print:my-0 [print-color-adjust:exact] [-webkit-print-color-adjust:exact]'
