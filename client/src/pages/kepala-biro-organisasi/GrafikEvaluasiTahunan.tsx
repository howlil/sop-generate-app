...
function EmptyState() {
  return (
    <div className="p-8 text-center border border-dashed border-gray-200 rounded-lg bg-gray-50">
      ...
      <p className="text-sm font-medium text-gray-600">Belum ada data penilaian OPD</p>
      <p className="text-xs text-gray-400 mt-1">Data akan muncul setelah ada riwayat penilaian OPD.</p>
    </div>
  )
}
