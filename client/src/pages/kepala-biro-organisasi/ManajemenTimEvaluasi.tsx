...
import { useTimEvaluasi } from '@/hooks/tim/useTimEvaluasi'
  ...
  return (
    ...
    >
          ...
          <tbody>
            {filteredTim.length === 0 ? (
              ...
              <Table.BodyRow key={tim.id}>
                ...
                <Table.Td className="text-gray-600 text-xs">{tim.nohp}</Table.Td>
                <Table.Td>
      ...
      <ConfirmDialog
        ...
        description="Data anggota akan dihapus dari daftar. Data evaluasi/arsip yang pernah mereka kerjakan tetap tersimpan per terjadwal verifikasi. Gunakan Nonaktifkan jika hanya mengakhiri tugas."
        onConfirm={() => {
          if (deleteTimId) {
