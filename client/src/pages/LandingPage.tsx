...
const workflowSteps = [
  ...
  },
  {
    ...
    title: "Evaluasi",
    description:
      "Tim Evaluasi menilai kesesuaian SOP terhadap standar yang berlaku secara terstruktur.",
    icon: Search,
    color: "amber",
  },
  {
...
const roleBenefits = [
  {
    role: "Tim Penyusun",
    description:
      "Fokus pada substansi, bukan administrasi. Editor prosedur visual membuat penyusunan SOP jadi lebih mudah.",
    features: [
      "Editor prosedur drag-and-drop",
      "Preview SOP real-time",
      "Template siap pakai",
      "Kolaborasi tim",
    ],
    icon: FileText,
  ...
  },
  {
    role: "Tim Evaluasi",
    description:
      "Penilaian terstruktur dengan rubrik yang jelas. Tidak ada lagi evaluasi yang subjektif atau tidak konsisten.",
    features: [
      "Rubrik evaluasi standar",
      "Dashboard tugas",
      "Riwayat penilaian",
      "Catatan terstruktur",
    ],
  ...
  },
  {
    ...
    description:
      "Pantau seluruh proses evaluasi dari hulu ke hilir. Verifikasi BA dengan satu klik.",
    features: [
      "Grafik evaluasi tahunan",
      "Manajemen tim",
      "Verifikasi BA digital",
      "Laporan otomatis",
    ],
    icon: CheckCircle,
  ...
  },
  {
    role: "Kepala OPD",
    description:
      "Pantau progres SOP di OPD Anda. Sahkan dokumen kapan saja, di mana saja, secara digital.",
...
const faqs = [
  {
    ...
    answer:
      "Platform digital terintegrasi untuk mengelola seluruh siklus hidup SOP — mulai dari penyusunan, evaluasi, verifikasi, hingga pengesahan dengan tanda tangan elektronik.",
  },
  {
    question: "Siapa saja yang bisa menggunakan sistem ini?",
    answer:
      "Sistem ini dirancang untuk 5 peran: Tim Penyusun, Koordinator Tim Penyusun, Tim Evaluasi, Biro Organisasi, dan Kepala OPD. Setiap peran memiliki dashboard dan fitur yang disesuaikan.",
  },
  {
    question: "Bagaimana keamanan tanda tangan elektronik?",
    answer:
      "Tanda tangan elektronik menggunakan sistem TTE (Tanda Tangan Elektronik) BSRE dengan PIN verifikasi dan jejak audit yang lengkap. Setiap penandatanganan tercatat dengan timestamp dan identitas penandatangan.",
  },
  {
    question: "Apakah data SOP tersimpan aman?",
    answer:
      "Ya. Seluruh data tersimpan di database terenkripsi dengan backup berkala. Setiap perubahan SOP tercatat dalam audit trail yang tidak dapat diubah.",
  },
];
...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border border-gray-200 rounded-lg overflow-hidden">
      ...
      <div
        className={cn("overflow-hidden transition-all duration-200", open ? "max-h-48" : "max-h-0")}
      >
    ...
    <div className="min-h-screen">
      ...
      <header
        className={cn(
          ...
          scrolled
            ? "border-b border-gray-200 bg-white/10 backdrop-blur-md "
      ...
      >
        ...
        <div className="relative flex items-center gap-2 border border-white/30 hover:border-white/50 rounded-full w-max mx-auto px-4 py-2 mt-0 md:mt-0 bg-white/10 backdrop-blur-sm">
          ...
          <a
            href="#cara-kerja"
            className="flex items-center gap-1 font-medium text-white hover:text-blue-100"
          >
        ...
        <p className="relative text-sm md:text-base mx-auto max-w-2xl text-center mt-6 text-gray-300 max-md:px-2">
          Dari penyusunan hingga pengesahan — seluruh proses SOP terdigitalisasi dengan jejak audit
          yang lengkap. Tidak ada lagi dokumen hilang, versi membingungkan, atau proses yang tidak
          terlacak.
        </p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center space-y-3 mb-12">
            ...
            <p className="text-gray-600 max-w-xl mx-auto text-sm">
              Setiap pengguna mendapatkan pengalaman yang disesuaikan dengan tugas dan tanggung
              jawabnya.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-6">
          ...
          <p className="text-blue-100 max-w-lg mx-auto text-sm leading-relaxed">
            Mulai gunakan platform ini untuk menyusun, mengevaluasi, dan mengesahkan SOP secara
            digital. Hubungi admin Biro Organisasi untuk pembuatan akun.
          </p>
          <Link to={ROUTES.AUTH.LOGIN}>
            <Button
              size="lg"
              className="bg-white text-blue-700 hover:bg-blue-50 h-11 text-sm font-medium"
            >
              Masuk ke Sistem
