...
start_marker = "## 5.1.2 Implementasi Pengkodean Backend (NestJS)"
end_marker = "## 4. Alur Data Sistem"

if start_marker in content and end_marker in content:
    start_idx = content.find(start_marker)
    end_idx = content.find(end_marker)
    
    replacement = """## 5.1.2 Implementasi Pengkodean Backend
...
"""
    ...
    with open(path, 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("Berhasil mengupdate arsitektur-sistem.md secara spesifik dan ketat menggunakan split")
else:
    print("Gagal menemukan marker!")
