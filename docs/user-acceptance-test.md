...
| PJ Penyusun | Login, membuat/melengkapi SOP, mengelola peraturan dan pelaksana, menandai SOP siap dievaluasi, membuat pengajuan evaluasi, membaca umpan balik, menandai tindak lanjut revisi selesai, mengirim ulang SOP hasil revisi, membuat atau memvalidasi PIN TTE, dan menandatangani berita acara setelah tahap PJ Evaluator. |
