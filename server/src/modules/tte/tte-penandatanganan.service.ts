...
import {
  ...
  hashDokumenKanonik,
  mapTtePeranResponse,
  resolveTteSigningSecret,
  runTteRepositoryMutation,
} from './tte-support';
import { TteRepository } from './tte.repository';
import type { TteBatchSignSopPengajuanResponse, TteRiwayatResponse } from './tte.service';
...
export class TtePenandatangananService {
  ...
  async tandaTanganiBa(
    ...
    const signatureFields = buildSignatureMetadata(this.signingSecret, {
      hashDokumen,
      userId: user.sub,
