...
const phraseMap = new Map([
  ...
  ['should_map_DIVERIFIKASI_PJ_EVALUATOR_to_BA_diverifikasi_biro', 'seharusnya memetakan DIVERIFIKASI_PJ_EVALUATOR menjadi BA diverifikasi biro'],
  ...
  ['should_map_selesai_dievaluasi_to_siap_diverifikasi', 'seharusnya memetakan SELESAI_DIEVALUASI menjadi SIAP_DIVERIFIKASI'],
  ['should_map_diverifikasi_pj_evaluator_to_siap_diverifikasi', 'seharusnya memetakan DIVERIFIKASI_PJ_EVALUATOR menjadi SIAP_DIVERIFIKASI'],
  ['should_map_ditandatangani_pj_penyusun_to_diverifikasi_pj_evaluator_organisasi', 'seharusnya memetakan DITANDATANGANI_PJ_PENYUSUN menjadi DIVERIFIKASI_PJ_EVALUATOR_ORGANISASI'],
